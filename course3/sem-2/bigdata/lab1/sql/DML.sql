...
SELECT DISTINCT product_category FROM all_data WHERE product_category IS NOT NULL AND product_category != ''
ON CONFLICT (category_name) DO NOTHING;

INSERT INTO dim_pet_category (pet_category_name)
SELECT DISTINCT pet_category FROM all_data WHERE pet_category IS NOT NULL AND pet_category != ''
ON CONFLICT (pet_category_name) DO NOTHING;

INSERT INTO dim_brand (brand_name)
SELECT DISTINCT product_brand FROM all_data WHERE product_brand IS NOT NULL AND product_brand != ''
ON CONFLICT (brand_name) DO NOTHING;

INSERT INTO dim_material (material_name)
SELECT DISTINCT product_material FROM all_data WHERE product_material IS NOT NULL AND product_material != ''
ON CONFLICT (material_name) DO NOTHING;

INSERT INTO dim_color (color_name)
SELECT DISTINCT product_color FROM all_data WHERE product_color IS NOT NULL AND product_color != ''
ON CONFLICT (color_name) DO NOTHING;

INSERT INTO dim_size (size_name)
SELECT DISTINCT product_size FROM all_data WHERE product_size IS NOT NULL AND product_size != ''
ON CONFLICT (size_name) DO NOTHING;

INSERT INTO dim_country (country_name)
SELECT DISTINCT country FROM (
    SELECT customer_country AS country FROM all_data WHERE customer_country IS NOT NULL AND customer_country != ''
    UNION
    SELECT seller_country AS country FROM all_data WHERE seller_country IS NOT NULL AND seller_country != ''
    UNION
    SELECT store_country AS country FROM all_data WHERE store_country IS NOT NULL AND store_country != ''
    UNION
    SELECT supplier_country AS country FROM all_data WHERE supplier_country IS NOT NULL AND supplier_country != ''
) AS countries
ON CONFLICT (country_name) DO NOTHING;

INSERT INTO dim_city (city_name)
SELECT DISTINCT city FROM (
    SELECT supplier_city AS city FROM all_data WHERE supplier_city IS NOT NULL AND supplier_city != ''
    UNION
    SELECT store_city AS city FROM all_data WHERE store_city IS NOT NULL AND store_city != ''
) AS countries
ON CONFLICT (city_name) DO NOTHING;

INSERT INTO dim_pet_breed (breed_name)
SELECT DISTINCT customer_pet_breed FROM all_data WHERE customer_pet_breed IS NOT NULL AND customer_pet_breed != ''
ON CONFLICT (breed_name) DO NOTHING;

INSERT INTO dim_pet_type (pet_type_name)
SELECT DISTINCT customer_pet_type FROM all_data WHERE customer_pet_type IS NOT NULL AND customer_pet_type != ''
