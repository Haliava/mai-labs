...
class FakeProduct:
    ...
    @classmethod
    def populate_product(cls) -> Tuple[Dict[str, Union[str, int]], Product]:
        """
    ...
    @classmethod
    def populate_product_with_options(cls, get_product_obj=True) -> Tuple[Dict[str, Union[str, int]], Union[Product, Dict]]:
        """
